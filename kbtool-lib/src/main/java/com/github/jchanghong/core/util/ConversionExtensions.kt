...
inline fun String.toShortOrThrow(crossinline throwable: String.() -> Throwable): Short =
    toShortOrRun { throw throwable() }
...
inline fun String.toFloatOrThrow(crossinline throwable: String.() -> Throwable): Float =
    toFloatOrRun { throw throwable() }
...
inline fun String.toDoubleOrThrow(crossinline throwable: String.() -> Throwable): Double =
    toDoubleOrRun { throw throwable() }
...
inline fun String.toBooleanOrNull(): Boolean? =
    if (equals("true", ignoreCase = true)) true else if (equals("false", ignoreCase = true)) false else null

inline fun String.toBooleanOrRun(defaultBlock: (String) -> Boolean): Boolean = toBooleanOrNull() ?: run(defaultBlock)
inline fun String.toBooleanOrThrow(crossinline throwable: String.() -> Throwable): Boolean =
    toBooleanOrRun { throw throwable() }
