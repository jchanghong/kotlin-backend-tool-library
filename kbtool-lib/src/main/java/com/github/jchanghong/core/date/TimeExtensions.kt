...
object Dates {
    ...
    fun of(date: Period, time: Duration, fromNow: fromNow): LocalDateTime =
...
inline fun Date.toLocalDateTime(zoneId: ZoneId = ZoneId.systemDefault()): LocalDateTime =
    LocalDateTime.ofInstant(toInstant(), zoneId)

inline fun String.parseDate(
    formatter: SimpleDateFormat = SimpleDateFormat(),
    zoneId: ZoneId = ZoneId.systemDefault()
): LocalDateTime = formatter.parse(this).toLocalDateTime(zoneId)

inline fun LocalDateTime.format(
    formatter: SimpleDateFormat = SimpleDateFormat(),
    zoneId: ZoneId = ZoneId.systemDefault()
): String = formatter.format(toDate(zoneId))
