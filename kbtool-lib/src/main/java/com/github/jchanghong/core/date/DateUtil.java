...
import com.github.jchanghong.core.comparator.CompareUtil;
import com.github.jchanghong.core.lang.Assert;
import com.github.jchanghong.core.lang.PatternPool;
import com.github.jchanghong.core.util.CharUtil;
import com.github.jchanghong.core.util.NumberUtil;
import com.github.jchanghong.core.util.ReUtil;
import com.github.jchanghong.core.util.StrUtil;
import com.github.jchanghong.core.date.format.DateParser;
import com.github.jchanghong.core.date.format.DatePrinter;
import com.github.jchanghong.core.date.format.FastDateFormat;
import com.github.jchanghong.core.date.format.GlobalCustomFormat;
...
public class DateUtil extends CalendarUtil {
	...
	public static String formatChineseDate(Date date, boolean isUppercase, boolean withTime) {
		...
		return formatChineseDate(calendar(date), withTime);
	}
	// ------------------------------------ Format end ----------------------------------------------
	...
	public static DateTime parse(String str, String... parsePatterns) throws DateException {
		return new DateTime(parseByPatterns(str, parsePatterns));
	}
	...
	public static boolean isSameWeek(final Date date1, final Date date2, boolean isMon) {
		...
		return isSameWeek(calendar(date1), calendar(date2), isMon);
	}
	...
	public static boolean isSameMonth(final Date date1, final Date date2) {
		...
		return isSameMonth(calendar(date1), calendar(date2));
	}
