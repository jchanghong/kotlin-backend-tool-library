...
tailrec fun gcd(a: BigInteger, b: BigInteger): BigInteger =
    if (b == BigInteger.ZERO) a else if (a.fitsInLong() && b.fitsInLong()) gcd(
        a.toLong(),
        b.toLong()
...
inline fun BigDecimal.round(precision: Int = 1, roundingMode: RoundingMode = RoundingMode.HALF_UP): BigDecimal =
    round(MathContext(precision, roundingMode))
...
inline fun Double.round(precision: Int = 1, roundingMode: RoundingMode = RoundingMode.HALF_UP): BigDecimal =
    round(MathContext(precision, roundingMode))

inline fun Float.round(precision: Int = 1, roundingMode: RoundingMode = RoundingMode.HALF_UP): BigDecimal =
    round(MathContext(precision, roundingMode))
...
inline fun BigInteger.sqrt(roundingMode: RoundingMode = RoundingMode.HALF_EVEN): BigInteger =
    BigIntegerMath.sqrt(this, roundingMode)

inline fun BigDecimal.sqrt(roundingMode: RoundingMode = RoundingMode.HALF_EVEN): BigInteger =
    toBigInteger().sqrt(roundingMode)
...
inline fun BigInteger.log10(roundingMode: RoundingMode = RoundingMode.HALF_EVEN): Int =
    BigIntegerMath.log10(this, roundingMode)

inline fun BigInteger.log2(roundingMode: RoundingMode = RoundingMode.HALF_EVEN): Int =
    BigIntegerMath.log2(this, roundingMode)
